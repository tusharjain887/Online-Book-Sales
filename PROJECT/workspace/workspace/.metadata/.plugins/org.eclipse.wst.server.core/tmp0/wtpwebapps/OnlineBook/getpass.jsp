...
System.out.println(check);
 if(check==1)
 {
	...
	System.out.println(check);
 %>
 <a href="http://api.mVaayoo.com/mvaayooapi/MessageCompose?user=chilukarakesh123@gmail.com:rakesh1234&senderID=TEST SMS&receipientno=<%=mob %>&dcs=0&msgtxt=<%=TEXT %>&state=0" target="_blank">Click To Receive SMS</a>
 <%
 }
	}
	else
