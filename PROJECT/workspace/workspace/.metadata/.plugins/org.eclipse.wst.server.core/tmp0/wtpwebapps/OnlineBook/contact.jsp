    ...
    <div class="center_content">
      ...
      <div class="prod_box_big">
        ...
        <div class="center_prod_box_big">
          ...
          <form name="myForm" action="contactus.jsp" method="post" onsubmit="return validate()">
            <div class="form_row">
            ...
            <div class="form_row"> <input type="submit" value="Submit"><input type="reset" value="Reset" /></div>
            </form>
          </div>
        </div>
