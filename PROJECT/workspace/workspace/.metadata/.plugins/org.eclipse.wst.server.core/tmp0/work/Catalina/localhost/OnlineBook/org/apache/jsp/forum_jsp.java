...
out.println("<img src='C:/Uploaded Images/"+rs9.getString(1)+"'></img>");
	...
	Conn8.close();
      ...
      out.write("      <div class=\"center_title_bar\">Forum</div>\r\n");
      out.write("      <div style=\"font-size:16px;color:#B13052;\">\r\n");
      out.write("      <table width=\"600\" border=\"0\" align=\"center\" cellpadding=\"18\" cellspacing=\"1\" bgcolor=\"#CCCCCC\">\r\n");
      out.write("<tr>\r\n");
      out.write("<td width=\"77%\" align=\"center\" bgcolor=\"#E6E6E6\"><strong>Topic</strong></td>\r\n");
      out.write("<td width=\"23%\" align=\"center\" bgcolor=\"#E6E6E6\"><strong>Replies</strong></td>\r\n");
      out.write("</tr>\r\n");
      out.write("     ");
	...
	while(rs1.next()) 
    {
      ...
      out.write("\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("<td width=\"77%\" align=\"center\" bgcolor=\"#E6E6E6\"><strong>");
out.println("<a href='view_thread.jsp?thread_id="+rs1.getInt(1)+"'>"+rs1.getString(3)+"</a>");
      out.write("</strong><br>Posted by ");
...
if(rs2.next()) 
{
      ...
      out.write("\r\n");
      out.write("\t<td width=\"23%\" align=\"center\" bgcolor=\"#E6E6E6\">");
out.println(rs2.getInt(1));
	...
	Conn1.close();
      ...
      out.write("\r\n");
      out.write("        <tr>\r\n");
      out.write("<td colspan=\"5\" align=\"right\" bgcolor=\"#E6E6E6\"><a href=\"create_thread.jsp\"><strong>Create New Topic</strong> </a></td>\r\n");
      out.write("</tr>\r\n");
      out.write("        ");
