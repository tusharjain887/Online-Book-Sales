...
if(c!=null)
 ...
 <br><br><br>
 <pre>
      Ideal Book Sales is a leading e-commerce company 
   and is an subsidiary of BookSales Inc.
      Starting in year 2010 , it has managed to build a
   huge customer base and generated large amount of revenue.
      It has also considered customer satisfiaction as 
   their main goal. 
      Many libraries of different institutions are associated
   with us.
      It is one of the widely used book selling company due to
   its offers on bulk purchase on books and also discounts on
   each book which attracts the customer. 
</pre>
