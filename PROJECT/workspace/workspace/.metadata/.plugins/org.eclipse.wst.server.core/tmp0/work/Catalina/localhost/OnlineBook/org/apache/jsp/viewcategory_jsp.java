...
out.println("<img src='C:/Uploaded Images/"+rs9.getString(1)+"'></img>");
	...
	Conn8.close();
      ...
      out.write("      <center><div style=\"font-size:16px;color:#B13052;\">\r\n");
      out.write(" ");
...
try{
	...
	PreparedStatement ps=Conn.prepareStatement("SELECT CAT_ID,CAT_NAME,CAT_DESCRIPTION FROM CATEGORY WHERE CAT_ID='"+cat_id+"'"); 
	ResultSet rs=ps.executeQuery();
	while(rs.next()) 
    {
		String name=rs.getString(2);
		out.println("<a href='viewcategory.jsp?cat_id="+rs.getString(1)+"'>"+name+"</a>");
 	 out.println("<br><br>"+rs.getString(3)+"<br><br><br>");
    }
	...
	PreparedStatement ps1=Conn1.prepareStatement("SELECT * FROM BOOKS WHERE CAT_ID='"+cat_id+"'"); 
